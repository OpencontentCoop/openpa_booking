<div id="path">
  <p>
    <span class="path-text"><strong>1. {"Shopping basket"|i18n("design/ezwebin/shop/basket")}</strong></span>
...
<form method="post" action={"/shop/basket/"|ezurl}>
  ...
  <h1>{"Basket"|i18n("design/ezwebin/shop/basket")}</h1>
...
{section name=Basket show=$basket.items}
  ...
  <table class="list"  width="100%" cellspacing="0" cellpadding="0" border="0">
    ...
    <tr class="bgdark">
        <td><input type="hidden" name="ProductItemCountList[]" value="{$Basket:ProductItem:item.item_count}" size="5" />{$Basket:ProductItem:item.item_count}</td>
        <td>
    ...
    <tr>
         <td colspan="4"></td>
         <td><strong>{"Subtotal ex. VAT"|i18n("design/ezwebin/shop/basket")}</strong>:</td>
         <td><strong>{"Subtotal inc. VAT"|i18n("design/ezwebin/shop/basket")}</strong>:</td>
    </tr>
    <tr>
        <td colspan="4"></td>
    ...
    {* Show order total *}
    <tr>
         <td colspan="5"><strong>{'Order total'|i18n( 'design/ezwebin/shop/basket' )}</strong>:</td>
  ...
  <div class="buttonblock object-right">
    <input class="defaultbutton" type="submit" name="CheckoutButton" value="Procedi con l'acquisto" />
  </div>
