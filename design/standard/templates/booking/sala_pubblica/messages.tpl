{set-block scope=root variable=email_subject}Vostra richiesta di prenotazione sala {$object.data_map.sala.content.name|wash()}{/set-block}
...
Cordiali Saluti<br/>
Il responsabile delle prenotazioni sale pubbliche - {ezini( 'SiteSettings', 'SiteName' )}<br/><br/>
{/set-block}
