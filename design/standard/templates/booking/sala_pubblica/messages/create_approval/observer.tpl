...
{set-block scope=root variable=email_body}
    ...
    Come responsabile dell'attrezzatura richiesta nella prenotazione, sei invitato a consultare l'indirizzo http://{ezini( "SiteSettings", "SiteURL" )}{concat( 'openpa_booking/view/sala_pubblica/', $object.id )|ezurl(no)}<br/>
